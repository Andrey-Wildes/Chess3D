...
pygame.init()
screen = pygame.display.set_mode((2 * BOARD_SIZE[0] + 2 * BORDER_SIZE, BOARD_SIZE[1]))
pygame.display.set_caption('3D Chess Game - Two Boards 8x8')
...
def initialize_pieces():
    ...
    shapes_board1 = [
        ["B-torre", "B-cavalo", "B-bispo", "B-rei", "B-rainha", "B-bispo", "B-cavalo", "B-torre"],
        ["B-peao", "B-peao", "B-peao", "B-peao", "B-peao", "B-peao", "B-peao", "B-peao"],
        ["", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", ""],
        ["P-peao", "P-peao", "P-peao", "P-peao", "P-peao", "P-peao", "P-peao", "P-peao"]
        ]
    shapes_board2 = [
        ["B-peao", "B-peao", "B-peao", "B-peao", "B-peao", "B-peao", "B-peao", "B-peao"],
        ["", "", "", "", "", "", "", "", "", ""],
        ...
        ["", "", "", "", "", "", "", "", "", ""],
        ["P-peao", "P-peao", "P-peao", "P-peao", "P-peao", "P-peao", "P-peao", "P-peao"],
        ["P-torre", "P-cavalo", "P-bispo", "P-rei", "P-rainha", "P-bispo", "P-cavalo", "P-torre"],
        ]
    for row in range(BOARD_HEIGHT):
        for col in range(BOARD_WIDTH):
            if row < 2:
    ...
    return pieces_group1, pieces_group2
pieces_group1, pieces_group2 = initialize_pieces()
def main():
